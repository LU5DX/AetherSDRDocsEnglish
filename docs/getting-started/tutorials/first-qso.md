...
- The **L / R pan** slider (default **50**, range 0–100) lets you position this slice's audio in the stereo field. Double-click it to reset to centre. The slider shows "C" at centre, "L5" at 45, "R10" at 60, and so on. The slider has a centre-anchored fill: the accent colour extends from the centre outwards toward the handle position, so you can see the pan balance at a glance.
