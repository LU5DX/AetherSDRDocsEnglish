...
- You must have attempted a connection to a Flex radio. The indicator is meaningful only after a connect attempt; it does not require the connection to be fully established.
