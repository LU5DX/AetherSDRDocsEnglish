...
|--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Port                           | Port the TCI WebSocket server listens on. Out-of-range values snap to `50001`. Has accessible name "TCI port" and accessible description "TCP port the TCI server listens on".                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Enable / Disabled              | Starts or stops the TCI server. Button text dynamically updates to "Enabled" when the server is running and "Disabled" when stopped. Has accessible name "TCI server enable".                    | The button is checkable. If Autostart TCI is enabled in settings, the button initializes as "Enabled" and checked. When toggling, the text updates immediately. If the bind fails, the button snaps back to unchecked and text reverts to "Disabled".                                                                                                                                                                                                                                                                                                                            |
| Server status                  | Displays `(stopped)`, `:<port> (N clients)`, or `(port in use)`. Turns red on bind failure.                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| RX1–RX8 gain+meter             | Combined meter/slider; drag sets the TCI RX gain for the channel and emits `tciRxGainChanged`.                                                                                                   | Each slider has an accessible name "TCI RX gain" followed by the channel number (1–8) for screen reader compatibility. Channels above the radio's slice capacity are hidden.                                                                                                                                                                                                                                                                                                                                                                                                    |
...
The RX1–RX8 gain+meter rows map to DAX channels 1–8. On radios with fewer than 8 slices, rows above the radio's slice capacity are hidden automatically. For example, a radio with 4 slices shows only RX1–RX4; a radio with 8 slices shows all RX1–RX8. The slice-assignment labels to the right of each row show which slice currently drives that channel.
...
- The Enable button text changes between "Enabled" and "Disabled" to clearly indicate the current server state.
...
- **Status stays `(stopped)` after clicking Enable** — The bind failed and Enable snapped back to off. The button text reverts to "Disabled". Check the Port value and confirm no other application is using that port.
