...
This page walks you through downloading and installing AetherSDR on Windows so you can connect to your Flex radio.

## Before you start

- Your Windows user account must have permission to run installers.
- Your Flex radio must be on the same network as your Windows machine.
...
6. When AetherSDR opens, go to `Settings > Connect to Radio...` to discover and connect to your Flex radio.
...
- **Radio not found in Connect to Radio...** — Confirm the Flex radio and the Windows machine are on the same subnet and that Windows Firewall is not blocking AetherSDR's network access. Add a firewall exception for AetherSDR if needed.
