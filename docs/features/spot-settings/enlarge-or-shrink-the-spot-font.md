...
- Toggle buttons (Spots, Memories, Override Colors, Override Background: Enabled, Spot Lines) now display "Enabled" when the feature is active and "Disabled" when the feature is inactive. Check the button text to determine the current state.
