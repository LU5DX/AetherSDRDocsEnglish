...
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| **Spots:** toggle button      | Master toggle for DX spot display. Click to toggle between enabled and disabled states. The button always displays "Enabled". Saved to `IsSpotsEnabled`.                                                                                                                                               | Enabled |
| **Memories:** toggle button   | Toggles memory channel overlays on the panadapter. Click to toggle between enabled and disabled states. The button always displays "Enabled". Saved to `IsMemorySpotsEnabled`. Setting key changed from `IsMemoriesShownOnPanadapter` in v0.9.7.                                                         | Disabled |
...
| **Override Colors:** toggle button | Forces a single text color for all spots. Click to toggle between enabled and disabled states. The button always displays "Enabled". Saved to `IsSpotsOverrideColorsEnabled`.                                                                                                                        | Disabled |
...
| **Override Background: Enabled** toggle button | Draws a background under spot text. Click to toggle between enabled and disabled states. The button always displays "Enabled". Saved to `IsSpotsOverrideBackgroundColorsEnabled`.                                                                                                         | Enabled |
| **Override Background: Auto** toggle button | Auto-picks background color for contrast. Click to toggle between enabled and disabled states. The button always displays "Enabled". Saved to `IsSpotsOverrideToAutoBackgroundColorEnabled`.                                                                                                 | Enabled |
...
| **Spot Lines:** toggle button | Draws vertical lines from the spectrum baseline up to each spot label. Click to toggle between enabled and disabled states. The button always displays "Enabled". Disable during contests to reduce visual clutter. Saved to `IsSpotsLinesEnabled`. Added in v0.9.7 (#2349).                              | Enabled |
...
- Toggle buttons always display "Enabled" regardless of their current checked state. The checked state is indicated by the button background color.
