...
- The dashed yellow filter cutoff guide lines visible on both the docked applet tile and the floating editor now update in real time whenever the radio changes its TX or RX passband, keeping the visual reference always current.
