...
| DXCC Colors:                                             | Colors spots by worked/confirmed/needed DXCC status. Toggle button always shows "Enabled" regardless of state.                                                                                                                                          | Setting key changed from `DxccColoringEnabled` to `IsDxccColoringEnabled` in v26.5.1.                                                                                         |
