...
- `Auto Mode:` is now enabled by default. When you click a spot that includes mode information (e.g. CW, FT8, RTTY), the slice mode switches automatically unless you disable this toggle.
