...
|---|---|---|---|
| **Freq** | 6000 Hz | 1000 – 12000 Hz | Logarithmic mapping (1000 * 12^n). Sets the centre frequency of the sibilance band. Label shows '6.0 kHz' above 1 kHz, 'N Hz' below. |
