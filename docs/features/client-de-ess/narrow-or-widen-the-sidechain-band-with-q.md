...
- If the applet is not visible, open the Aetherial Audio Channel Strip, which hosts the de-esser controls directly. The floating StripDeEssPanel (accessible through the Channel Strip) includes the Slop button; the docked Aetherial De-Esser applet omits the Attack, Release, and Slope knobs/buttons.
