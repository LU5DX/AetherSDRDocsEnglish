...
|-------------------------------------------------------------------------------------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **TX**                                                                                    | Toggle button | Shows the TX DSP chain. Amber 'PooDoo' colour when selected. Last-active tab persists.                                                                                                                                                                                                                                                                                                 |
| **RX**                                                                                    | Toggle button | Shows the RX DSP chain. Amber 'PooDoo' colour when selected. Last-active tab persists.                                                                                                                                                                                                                                                                                                 |
...
| RX chain stage (**EQ** / **AGC-G** / **AGC-C** / **DESS** / **TUBE** / **EVO**)           | Stage tile    | Single-click toggles bypass. Double-click opens the stage's frameless floating editor in RX mode. Drag reorders the RX chain independently of the TX chain. All six stages fully implemented.                                                                                                                                                                                          |
