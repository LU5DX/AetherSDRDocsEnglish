...
|---------|-----|-------|---------|-------------|----------|
| RX antenna button | — | **RX** (icon) | — | — | Opens antenna selection menu for the receive antenna of this slice. |
| TX antenna button | — | **TX** (icon) | — | — | Opens antenna selection menu for the transmit antenna of this slice. |
| Frequency display | — | (frequency readout) | — | — | Shows the current slice frequency. Click once to begin direct frequency entry; type the frequency in MHz and press Enter or Tab. |
| Filter width label | — | (bandwidth readout) | — | — | Shows current filter bandwidth. Click to cycle through filter preset buttons in the Mode tab. |
