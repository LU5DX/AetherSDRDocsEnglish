...
|---|---|---|---|
| **Body / Drive** (TX) | 6.0 dB | 0.0 to 24.0 dB | `ClientPuduTxPooDriveDb` |
| **Body / Drive** (RX) | 6.0 dB | 0.0 to 24.0 dB | `ClientPuduRxPooDriveDb` |

The mapping is linear. Higher values push the low-frequency saturator (Even mode) or bass compressor (Odd mode) harder, producing more LF effect at the same **Body / Mix** blend level.

## Tips

- The AetherVoice™ logo pulses with the wet-signal RMS. Watch it while turning **Drive** — visible pulsing on bass content confirms the stage is processing.
...
- Drive and **Body / Mix** interact. A high Drive with a low Mix can deliver heavy low-end processing that is blended in subtly. See [Blend the Body enhancement with Mix](blend-the-poo-enhancement-with-mix.md).
- To focus the Drive on a specific frequency, set **Body / Tune** first. See [Tune Body to the fundamental of your voice (TX) or to bring out RX program lows](tune-poo-to-the-fundamental-of-your-voice-tx-or-to-bring-out-rx-program-lows.md).
