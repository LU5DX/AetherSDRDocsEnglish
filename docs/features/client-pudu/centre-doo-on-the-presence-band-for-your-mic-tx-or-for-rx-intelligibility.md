...
4. Monitor the PooDoo logo — its pulse brightness reflects the processed wet-signal level and gives a real-time indication that the Clarity section is active.
...
| **Doo / Air** (TX) | 6.0 dB | 0.0 – 24.0 dB | `ClientPuduTxDooHarmonicsDb` | Amount of harmonics added at the Clarity band. |
| **Doo / Air** (RX) | 6.0 dB | 0.0 – 24.0 dB | `ClientPuduRxDooHarmonicsDb` | Amount of harmonics added at the Clarity band. |
