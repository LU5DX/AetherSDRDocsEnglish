...
- Open the Poodoo editor by double-clicking the PUDU stage in the CHAIN widget. The editor is titled "Aetherial Voice Processor — TX" or "Aetherial Voice Processor — RX" depending on which side you are working on.
