...
- Open the Aetherial TX Voice Processor or Aetherial RX Poodoo™ applet in the Applet Panel, or double-click the PUDU stage in the CHAIN widget to open the floating editor titled "Aetherial Poodoo™ — TX" or "Aetherial Poodoo™ — RX".
...
Starting with version 26.5.2, you can type an exact value directly on the knob instead of dragging. Click the value text below any knob to reveal an inline editor. Type a number and press Enter or click elsewhere to commit. The value is automatically clamped to the valid range. Press Escape to cancel the edit and revert to the previous value.
...
| Doo / Tune       | 5000 Hz                                                                                      | 1000 to 10000 Hz                          |
| Doo / Mix        | 30 %                                                                                         | 0 to 100 %                                |
