...
| `Add` button                | Creates a new memory from the current (active) slice.                                                                                                                        | The slice-letter badge variant was dropped; adding always targets the active slice. Ctrl+N shortcut. |
