...
|---|---|---|
| Send | Submits the typed buffer if Live is off. If Live is on, turns off live sending and switches to the send view without retransmitting already-keyed characters. | — |
