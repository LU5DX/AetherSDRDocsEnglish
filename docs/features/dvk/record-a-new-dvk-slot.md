...
Use the Digital Voice Keyer panel to record your voice into one of up to 8 slots, which you can then play back on-air with a single click or F-key press.
...
1. In the DVK panel, click the slot row you want to record into (F1 through F8). The selected row highlights with a blue border.
