...
Set the DEXP gate threshold by dragging the **DEXP threshold** slider. The slider range is 0 to 100. The slider displays the value as a percentage while dragging. This setting is not persisted locally by AetherSDR — it is sent directly to the radio.
...
| **DEXP**           | Toggles downward expander (noise gate) on/off.                      | —       | None        |
| **DEXP threshold** | Sets DEXP gate threshold (0-100). Not persisted locally.            | 0       | None        |
