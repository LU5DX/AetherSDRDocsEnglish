...
2. Select the path you want to shape: click RX to work on the receive equalizer, or click TX to work on the transmit equalizer. The applet opens on the TX view by default.
...
| TX | Selects the transmit path for display and editing. Shows blue when active. | checked | — |
| 63 | Vertical slider that trims the 63 Hz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 125 | Vertical slider that trims the 125 Hz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 250 | Vertical slider that trims the 250 Hz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 500 | Vertical slider that trims the 500 Hz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 1k | Vertical slider that trims the 1 kHz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 2k | Vertical slider that trims the 2 kHz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 4k | Vertical slider that trims the 4 kHz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| 8k | Vertical slider that trims the 8 kHz band for the selected path. Value label below slider updates live. | 0 dB | −10 to +10 dB |
| +10 / 0 / -10 dB scale | Reference labels to the left and right of the slider column indicating the range of the sliders. | — | — |

## Tips

- The applet opens on the TX view by default. There is no persistent memory of your last-used view.
