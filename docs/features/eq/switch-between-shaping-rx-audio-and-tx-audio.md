...
| 63 | Slider | 0 dB | −10 to +10 dB | Trims the 63 Hz band for the selected path; value label below slider updates live. While dragging, a popup shows the signed dB value. |
| 125 | Slider | 0 dB | −10 to +10 dB | Trims the 125 Hz band for the selected path. While dragging, a popup shows the signed dB value. |
| 250 | Slider | 0 dB | −10 to +10 dB | Trims the 250 Hz band for the selected path. While dragging, a popup shows the signed dB value. |
| 500 | Slider | 0 dB | −10 to +10 dB | Trims the 500 Hz band for the selected path. While dragging, a popup shows the signed dB value. |
| 1k | Slider | 0 dB | −10 to +10 dB | Trims the 1 kHz band for the selected path. While dragging, a popup shows the signed dB value. |
