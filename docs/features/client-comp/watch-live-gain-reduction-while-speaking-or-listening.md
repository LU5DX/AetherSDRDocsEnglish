...
| Thresh | Knob | Current threshold. Default -18.0 dB; range -60.0 to 0.0 dB. Click the value to type a precise threshold. | TX: `ClientCompTxThresholdDb`. RX: `ClientCompRxThresholdDb`. |
| Ratio | Knob | Current ratio. Default 3.0; range 1.0 to 20.0. Displayed as X.XX:1. Click the value to type a precise ratio. | TX: `ClientCompTxRatio`. RX: `ClientCompRxRatio`. |
| Attack | Knob | Current attack time. Default 20.0 ms; range 0.1 to 300.0 ms. Click the value to type a precise attack time. | TX: `ClientCompTxAttackMs`. RX: `ClientCompRxAttackMs`. |
| Release | Knob | Current release time. Default 200 ms; range 5 to 2000 ms. Click the value to type a precise release time. | TX: `ClientCompTxReleaseMs`. RX: `ClientCompRxReleaseMs`. |
| Makeup | Knob | Current makeup gain. Default 0.0 dB; range -12.0 to 24.0 dB. Click the value to type a precise makeup gain. | TX: `ClientCompTxMakeupDb`. RX: `ClientCompRxMakeupDb`. |
